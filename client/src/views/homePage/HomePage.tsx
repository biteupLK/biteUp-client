  ...
  return (
    <ThemeProvider theme={theme}>
      <Box sx={{ flexGrow: 1, bgcolor: '#F7F9FC', minHeight: '100vh' }}>
        {/* App Bar */}
        <AppBar position="sticky" elevation={0} sx={{ bgcolor: 'white', color: '#333', borderBottom: '1px solid #eee' }}>
          <Toolbar>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Typography variant="h5" sx={{ fontWeight: 700, color: '#FF4757', display: 'flex', alignItems: 'center' }}>
                <RestaurantIcon sx={{ mr: 1, transform: 'rotate(45deg)' }} /> FoodGo
              </Typography>
            </Box>
            ...
            {!isMobile ? (
              <Box sx={{ display: 'flex', alignItems: 'center', ml: 'auto' }}>
                <Button 
                  ...
                  sx={{ color: '#333', textTransform: 'none', mr: 2, fontWeight: 500 }}
                >
                  123 Main St
                </Button>
                <Button sx={{ mx: 1, color: '#333', fontWeight: 500 }}>Restaurants</Button>
                <Button sx={{ mx: 1, color: '#333', fontWeight: 500 }}>Deals</Button>
        ...
        <Container sx={{ py: 4 }}>
          ...
          <Paper 
            ...
            sx={{ 
              ...
              py: 6, 
              px: 2,
              backgroundImage: 'linear-gradient(to right, rgba(255,255,255,0.95), rgba(255,255,255,0.95)), url(/api/placeholder/1200/300)',
          ...
          >
            ...
            >
              Delicious food, delivered <Box component="span" sx={{ color: '#FF4757' }}>fast</Box>
            </Typography>
            <Typography 
              variant="subtitle1" 
              sx={{ 
          ...
          <Box sx={{ mb: 6 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
              <Typography variant="h6" sx={{ fontWeight: 700, display: 'flex', alignItems: 'center' }}>
                <LocalOfferIcon sx={{ mr: 1, color: '#FF4757' }} /> Featured Deals
              </Typography>
              <Button 
                ...
                <Grid item xs={12} sm={6} key={index}>
                  ...
                  >
                    ...
                    <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                      <Typography variant="h6" component="h3" sx={{ fontWeight: 700, color: '#FF4757' }}>
                        {deal.title}
                      </Typography>
          ...
          <Box sx={{ mb: 6 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
              <Typography variant="h6" sx={{ fontWeight: 700, display: 'flex', alignItems: 'center' }}>
                <RestaurantIcon sx={{ mr: 1, color: '#FF4757' }} /> Popular Restaurants
              </Typography>
              <Button 
                endIcon={<KeyboardArrowRightIcon />} 
                sx={{ color: '#FF4757', fontWeight: 500 }}
                  ...
                  >
                    ...
                    <CardContent sx={{ pt: 3 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', color: '#666', mb: 1 }}>
                        <AccessTimeIcon sx={{ fontSize: '0.9rem', mr: 0.5, color: '#98A2B3' }} />
                        <Typography variant="body2" sx={{ color: '#666' }}>
                          {restaurant.time}
                        </Typography>
                        <Box sx={{ mx: 1, fontSize: '0.5rem', color: '#98A2B3' }}>•</Box>
                        <DeliveryDiningIcon sx={{ fontSize: '0.9rem', mr: 0.5, color: '#98A2B3' }} />
                        <Typography variant="body2" sx={{ color: '#666' }}>
                          Free delivery
                        </Typography>
                      </Box>
                      <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
                        {restaurant.tags.map((tag, i) => (
                          <Chip 
                            ...
                            label={tag} 
                            size="small" 
                            sx={{ bgcolor: '#f0f0f0', color: '#666', fontWeight: 500 }} 
                          />
                        ))}
                      </Box>
                    </CardContent>
              ...
              <Grid item xs={12} md={7}>
                <CardContent sx={{ p: { xs: 4, md: 5 } }}>
                  ...
                  <Typography variant="body1" sx={{ mb: 3, opacity: 0.9 }}>
                    Get exclusive deals and faster ordering with our mobile app. Plus, enjoy special offers only available to app users!
                  </Typography>
          ...
          <Box sx={{ pt: 4, pb: 8, textAlign: 'center' }}>
            <Divider sx={{ mb: 4 }} />
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#FF4757', mb: 2 }}>
